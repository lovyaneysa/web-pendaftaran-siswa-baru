...
function tampilsiswa(){
	...
	$sql="SELECT*FROM formulir_mhs AS u INNER JOIN data_siswa AS i  ON u.id=i.id_pendaftar INNER JOIN bukti_transfer AS a ON i.id_pendaftar=a.id_pendaftar WHERE a.status='1' AND YEAR(tgl_daftar)='2021' OR a.status='2' AND YEAR(tgl_daftar)='2021' ";
